...
export default function PESSocietyPage(props) {
    ...
    useEffect(() => {
        axios.get(hostname+'/api/event/cat/' + ecats.pes)
            .then(response => {
    ...
    return (
        <div className={classes.root}>
            <img src={images.landing.pes} id='soclanding' alt="Power and Energy Society" style={{ maxHeight: "100vh", width: "100%" }} />
                ...
                <Paper className={classes.paper}>
                    ...
                    <Typography variant='body1'>
                        <ul>
                            ...
                            <li>To provide a platform for professionals in power and energy to share interchange the technological development, ideas and experience amongst one another and to the masses </li>
                            <li>To ensure many student members of PES chapter become professionals in power and energy field and contribute to the society in this sector.</li>
                    ...
                    events.length!==0 && (
                        <>
                            <Paper className={classes.paper}>
                                ...
                                {
                                    events.length>=4 && (
                                        <Link to={"/events?ecat=" + ecats.pes} className={classes.link}>Click here for more events</Link>
                                    )
                                }
                            </Paper>
                            <SpacyDivider color="rgb(53 176 232)"/>
