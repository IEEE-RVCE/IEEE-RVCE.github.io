...
import {societyNav, societies, affinities} from '../links';
...
export default function SocietyHeader(props) {
    ...
    const Buttons = () => {
        let buttons = societyNav.map((nav) => {
            return(
            ...
            <ElevationScroll {...props}>
                <AppBar position="fixed" className={classes.appbar}>
                    <Toolbar style={{padding: 0}}>
                            ...
                            <div className={classes.brand}>
                                <img src='/assets/images/ieee_computer_black.png' height="40px" style={{float:"right", marginRight: "1%"}} alt="IEEE logo"/>
                            </div>
                            <div className={classes.brand}>
                                <img src='/assets/images/ieee_blue.jpg' height="40px" style={{float:"right", marginRight: "10%"}} alt="IEEE logo"/>
                            </div>
                            <IconButton
                                color="primary"
