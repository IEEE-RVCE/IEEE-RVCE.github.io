      ...
      <Container maxWidth="md">
        ...
        <Paper className={classes.paper}>
          ...
          <Typography variant="body1">
            To help members learn about Theory, Design and fabrication and applications of devices for sensing and
            transducing physical and biological phenomena while focusing on the electronics to create sensors and
            actuators.
          </Typography>
        </Paper>
...
3. Enable collaborative efforts within societies to work together in a multi-disciplinary technical area of mutual interest. */}
            <ol>
              <li>To teach members more about the importance,working and design of sensors and actuators</li>
              <li>To help students know about the latest trends in sensors and related fields of interest</li>
              <li>
                Enable collaborative efforts within societies to work together in a multi-disciplinary technical area of
                mutual interest.
              </li>
            </ol>
          </Typography>
